...
namespace ThuMuaHangWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            var isUsernameExist = await _userManager.FindByNameAsync(Input.Username.Trim());
            if (isUsernameExist != null && isUsernameExist.Status != "I")
            {
                StatusMessage = "Error: Username đã tồn tại. Vui lòng nhập lại username mới"; 
                return Page();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                await _phoneStore.SetPhoneNumberAsync(user, Input.Phone.Trim(), CancellationToken.None);
        ...
        private IUserPhoneNumberStore<ApplicationUser> GetPhoneStore()
        {
